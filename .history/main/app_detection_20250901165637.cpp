...
#include "app_camera_c.h"




// DlDetection::DlDetection()
//     : _s1(0.1F, 0.5F, 10, 0.2F)
//     , _s2(0.5F, 0.3F, 5){
//         this->init();
//     }
...
DlDetection::~DlDetection() {
    ...
    //     free(rgb888_image_data);
    //     rgb888_image_data = nullptr;
    // }
    if (rgb888_pic.buf) {
           free(rgb888_pic.buf);
...
void DlDetection::takePicture(uint8_t *buffer, int &height, int &width){
    ...
    // uint8_t *rgb888_image_data = (uint8_t *)malloc(width * height * 3);
    // convert_frame_rgb565_to_rgb888(pic->buf, rgb888_image_data, width, height);
