    ...
    def generate():
        ...
        while True:
            if latest_frame is not None:
                ...
                # Draw all bounding boxes as circles
                # for (x, y) in latest_boxes:
                if bb_x != 0 and bb_y != 0 
                    cv2.circle(frame_with_boxes, (x, y), 10, (0, 0, 255), 2)
